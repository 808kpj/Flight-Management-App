Public Class frmAdminAddFutureFlightPilot
    Private Sub frmAdminAddFutureFlightPilot_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Try
            ...
            If cboFutureFlights.Text = String.Empty Then
                ...
                Exit Try
            ElseIf cboPilots.Text = String.Empty Then
                MessageBox.Show("Please select a Pilot")
                cboPilots.Focus()
                Exit Try
            Else
                result = MessageBox.Show("Are you sure you want to assign this pilot " & cboPilots.Text & " to this date: " & cboFutureFlights.Text & "?", "Confirm Deletion", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question)
