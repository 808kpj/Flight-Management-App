Public Class frmAdminPilotUpdate
    ...
    Private Sub frmAdminManagePilots_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim dtPilotName As DataTable = New DataTable ' this is the table we will load from our reader
        ...
        Try
            ...
            strSelect = "SELECT intPilotID, strFirstName + ' ' + strLastName as Name FROM TPilots"

            ' Retrieve all the records 
            cmdSelect = New OleDb.OleDbCommand(strSelect, m_conAdministrator)
            drSourceTable = cmdSelect.ExecuteReader
            dtPilotName.Load(drSourceTable)
            ...
            cboPilotNames.DisplayMember = "Name"
            'fills the combo box with data passed into it
            cboPilotNames.DataSource = dtPilotName
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        intPilotID = cboPilotNames.SelectedValue
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboPilotNames.SelectedIndexChanged
        Dim strSelect As String
        Dim cmdSelect As OleDb.OleDbCommand ' this will be used for our Select statement
        Dim drSourceTable As OleDb.OleDbDataReader ' this will be where our data is retrieved to
