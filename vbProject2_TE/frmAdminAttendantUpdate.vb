Public Class frmAdminAttendantUpdate
    ...
    Private Sub frmAdminAttendantUpdate_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim strSelect As String
        Dim cmdSelect As OleDb.OleDbCommand ' this will be used for our Select statement
        Dim drSourceTable As OleDb.OleDbDataReader ' this will be where our data is retrieved to
        Dim dtAttendantName As DataTable = New DataTable ' this is the table we will load from our reader
        ...
        Try
            ...
            strSelect = "SELECT intAttendantID, strFirstName + ' ' + strLastName as Name FROM TAttendants"

            ' Retrieve all the records 
            cmdSelect = New OleDb.OleDbCommand(strSelect, m_conAdministrator)
            drSourceTable = cmdSelect.ExecuteReader
            dtAttendantName.Load(drSourceTable)
            ...
            cboAttendantNames.DisplayMember = "Name"
            'fills the combo box with data passed into it
            cboAttendantNames.DataSource = dtAttendantName
    ...
    Private Sub cboAttendantNames_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboAttendantNames.SelectedIndexChanged
        Dim strSelect As String
        Dim cmdSelect As OleDb.OleDbCommand ' this will be used for our Select statement
        Dim drSourceTable As OleDb.OleDbDataReader ' this will be where our data is retrieved to
        Dim dtAttendantName As DataTable = New DataTable ' this is the table we will load from our reader
        ...
        intAttendentID = cboAttendantNames.SelectedValue
